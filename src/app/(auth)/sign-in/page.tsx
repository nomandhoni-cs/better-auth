  ...
  return (
    <div className="w-full space-y-8 p-8 rounded-lg shadow-md border border-white/20 bg-black/40 backdrop-blur-sm">
      <div className="text-center space-y-2">
        <h2 className="text-2xl font-semibold text-[#44cc00]">Welcome back</h2>
      ...
      <div className="text-center">
        <p className="text-sm text-gray-400">
          ...
          <Link
            href="/sign-up"
            className="text-[#44cc00] hover:text-[#44cc00]/80  transition-colors"
          >
            Sign up
          </Link>
        </p>
      ...
      <div className="text-center text-xs text-gray-500">
        ...
        <Link href="/terms" className="text-[#44cc00] hover:text-[#44cc00]/80 ">
          Terms of Service
        </Link>{" "}
        and{" "}
        <Link
          href="/privacy"
          className="text-[#44cc00] hover:text-[#44cc00]/80 "
        >
          Privacy Policy
        </Link>
        .
